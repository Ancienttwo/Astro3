 ...
 */
export const TIANMA_MAP = {
    寅: '申', 午: '申', 戌: '申', // 寅午戌见申
    申: '寅', 子: '寅', 辰: '寅', // 申子辰见寅
    亥: '巳', 卯: '巳', 未: '巳', // 亥卯未见巳
    巳: '亥', 酉: '亥', 丑: '亥', // 巳酉丑见亥
};
export const TIANKUI_MAP = {
    甲: '丑', 戊: '丑', 庚: '丑',
    乙: '子', 己: '子',
    丙: '亥', 丁: '亥',
    壬: '卯', 癸: '卯',
...
export const LUCUN_MAP = {
    甲: '寅', 乙: '卯', 丙: '巳', 丁: '午',
    戊: '巳', 己: '午', 庚: '申', 辛: '酉',
    壬: '亥', 癸: '子',
};
export const HONGLUAN_MAP = {
    子: '卯', 丑: '寅', 寅: '丑', 卯: '子',
    辰: '亥', 巳: '戌', 午: '酉', 未: '申',
    申: '未', 酉: '午', 戌: '巳', 亥: '辰',
};
 ...
 */
export const PALACE_TRIANGLES = {
    0: [4, 8], 1: [5, 9], 2: [6, 10], 3: [7, 11],
    4: [0, 8], 5: [1, 9], 6: [2, 10], 7: [3, 11],
    8: [0, 4], 9: [1, 5], 10: [2, 6], 11: [3, 7],
};
export function getOppositePalace(index) {
    return (index + 6) % 12;
}
export function getPalaceSquare(index) {
...
//# sourceMappingURL=ziwei-constants.js.map