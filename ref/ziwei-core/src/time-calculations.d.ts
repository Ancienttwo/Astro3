 ...
 * @param year 目标年份
 */
export declare function getFleetingYear(birthDate: Date, year: number, lifePalaceIndex?: number): FleetingYearInfo;
/**
 * 流月信息
 */
 ...
 * @param month 月份 (1-12)
 */
export declare function getFleetingMonth(birthDate: Date, year: number, month: number, lifePalaceIndex?: number): FleetingMonthInfo;
/**
 * 小限信息
 */
 ...
 * @param yearBranch 年支
 */
export declare function getMinorLimit(birthDate: Date, targetDate: Date, gender: 'male' | 'female', yearBranch: string, lifePalaceIndex?: number): MinorLimitInfo;
export declare function getMinorLimit(chartContext: {
    birthDate: Date;
    gender: 'male' | 'female';
    yearBranch: string;
    lifePalaceIndex?: number;
}, targetDate: Date): MinorLimitInfo;
/**
 * 时间跨度信息
 */
