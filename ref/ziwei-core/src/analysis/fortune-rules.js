...
export const SIX_BODY_PALACES = new Set(['命宫', '夫妻宫', '疾厄宫', '田宅宫', '福德宫', '父母宫']);
export const SIX_USE_PALACES = new Set(['兄弟宫', '子女宫', '财帛宫', '迁移宫', '交友宫', '官禄宫']);
...
export const FLYING_EXCHANGE_RULES = [
...
export const PERIOD_FINANCE_TABLE = [
...
//# sourceMappingURL=fortune-rules.js.map