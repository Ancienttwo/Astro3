export const HEALTH_CORE_PRINCIPLES = [
    {
        title: '寿元与健康判别顺序',
        details: [
...
export const HEALTH_RISK_COMBINATIONS = [
    {
        title: '寿元高风险组合',
        conditions: [
...
export const HEALTH_RISK_INDEX = [
...
export const SUICIDAL_PATTERNS = [
    {
        title: '自杀象成立要件',
        conditions: [
...
export const ACCIDENT_PATTERNS = [
    {
        title: '终身意外关注',
        conditions: [
...
export const TRAFFIC_VEHICLE_MAPPING = {
    太阴: '四轮私用车',
    文昌: '四轮公共车或计程车',
    文曲: '四轮公共车或计程车',
    巨门: '大卡车、砂石车',
...
//# sourceMappingURL=health-rules.js.map