...
export async function generateIntegratedChart(
  ...
  const analysis: IntegratedChartAnalysis = {
...
): Promise<{ hookChart: ZiWeiHookChart; renderData: WebRenderData; analysis: IntegratedChartAnalysis }> {
...
export async function generateNativeChart(
  input: HookCalculationInput,
  options: Partial<RenderOptions> = {}
): Promise<{ hookChart: ZiWeiHookChart; renderData: NativeRenderData; analysis: IntegratedChartAnalysis }> {
