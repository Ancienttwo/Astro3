...
// 五行局查对表 - 正确的紫微斗数五行局表
// 使用年天干 + 命宫地支查表
export const FIVE_ELEMENTS_BUREAU = {
    // 甲己组
    '甲子': '水二局', '甲丑': '水二局',
    '甲寅': '火六局', '甲卯': '火六局',
    '甲辰': '木三局', '甲巳': '木三局',
...
// 五行局名称到表格列索引的映射
export const BUREAU_NAME_TO_COLUMN = {
    '水二局': 0,
    '木三局': 1,
    '金四局': 2,
    '土五局': 3,
...
// 五行局代码到列索引的映射
export const BUREAU_CODE_TO_COLUMN = {
    'water_2': 0,
    'wood_3': 1,
    'metal_4': 2,
    'earth_5': 3,
...
export const MAJOR_PERIOD_START_AGE = {
...
//# sourceMappingURL=five-elements-bureau.js.map