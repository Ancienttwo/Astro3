        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Wu Xing (五行) - The fundamental cycles of creation and control
            </p>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              The theory of Five Elements (五行 - Wǔ Xíng) is a fundamental concept in traditional Chinese philosophy used to explain a wide range of phenomena, from cosmic cycles to the workings of the human body. It involves two main cycles: the <strong>Generation Cycle</strong> (相生 - xiāngshēng) and the <strong>Destruction or Overcoming Cycle</strong> (相克 - xiāngkè).
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              1. The Generation Cycle (相生 - xiāngshēng)
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Cycle visualization:</strong> Wood → Fire → Earth → Metal → Water → Wood...
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              2. The Destruction / Overcoming Cycle (相克 - xiāngkè)
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              <p className="text-sm text-red-800 dark:text-red-200">
                <strong>Cycle visualization:</strong> Wood → Earth → Water → Fire → Metal → Wood...
              </p>
            </div>
          </CardContent>
        </Card>
              ...
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    ...
                    <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Generates (生)</th>
                    <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Is Generated By (被生)</th>
                    <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Destroys (克)</th>
                    <th className="border border-gray-300 dark:border-gray-600 p-3 text-left font-semibold">Is Destroyed By (被克)</th>
                  </tr>
                </thead>
                <tbody>
                  {elements.map((element) => (
